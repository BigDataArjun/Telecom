...
CREATE TABLE GEO_TAGGED_MEASUREMENTS_HIVE
   (	IMSI String, 
	IMEI String,
	MAKE String, 
	MODEL String, 
...
DROP TABLE HBASE_GEO_TAGGED_MEASUREMENTS_HIVE;
CREATE TABLE HBASE_GEO_TAGGED_MEASUREMENTS_HIVE (key string, COUNTOFRECORDS INT,ENDCELLID int, ELAT DOUBLE, ELON DOUBLE, GLOBALCELLID String,RSRPBINAVGNEW DOUBLE,RSRQBINAVGNEW DOUBLE,SETDATE String) STORED BY 
'org.apache.hadoop.hive.hbase.HBaseStorageHandler' with SERDEPROPERTIES('hbase.columns.mapping'=':key, COUNTOFRECORDS:val,ENDCELLID:val, ELAT:val, ELON:val, GLOBALCELLID:val,RSRPBINAVGNEW:val,RSRQBINAVGNEW:val,SETDATE:val') 
TBLPROPERTIES('hbase.table.name'='GEO_MEASUREMENTS_HBASE');
